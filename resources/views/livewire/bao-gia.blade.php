	...
	<div>
		...
		<head>
			...
			<meta name="description"
				content="Bảng báo giá đèn led kingled 2019, bảng giá đèn led kingled, đèn led âm trần kingled, bóng đèn led bulb, bảng giá bóng đèn led kingled." />
...
/* ]]> */
			...
			<link rel="alternate" title="JSON" type="application/json" href="/assets/wp-json/wp/v2/pages/897" />
			<link rel="alternate" title="oNhúng (JSON)" type="application/json+oembed"
				href="/assets/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fkingledvietnam.com%2Fbao-gia%2F" />
			<link rel="alternate" title="oNhúng (XML)" type="text/xml+oembed"
				href="/assets/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fkingledvietnam.com%2Fbao-gia%2F&#038;format=xml" />
			...
			<script type="application/ld+json">
				{"@context":"https:\/\/schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"item":{"@id":"https:\/\/kingledvietnam.com\/","name":"Home"}},{"@type":"ListItem","position":2,"item":{"@id":"https:\/\/kingledvietnam.com\/bao-gia\/","name":"B\u00e1o Gi\u00e1"}}]}
		...
		<body data-rsssl=1
			class="page-template-default page page-id-897 theme-flatsome woocommerce-no-js wp-schema-pro-2.7.10 lightbox nav-dropdown-has-arrow nav-dropdown-has-shadow nav-dropdown-has-border">
							...
							<form class="woocommerce-form woocommerce-form-login login" method="post">
								...
								<p class="form-row">
									...
									<input type="hidden" id="woocommerce-login-nonce" name="woocommerce-login-nonce"
										...
										value="/bao-gia/" /> <button type="submit"
