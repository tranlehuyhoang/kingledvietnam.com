                    ...
                    <div id="content" role="main" class="content-area">
                                                ...
                                                <a class="plain" href="{{ url('/cua-hang/' . $category->slug) }}">
                                                    <div class="icon-box featured-box icon-box-left text-left">
                                                        ...
                                                        <div class="icon-box-text last-reset">
                                                            <div id="text-{{ $category->id }}"
                                                                class="text text-chem-no">
                                                                <h3>
                                                                    <span
                                                                        style="color: #000000; font-family: avo; font-size: 75%;">
                                                                        <a style="color: #000000;"
                                                                            href="{{ url('/cua-hang/' . $category->slug) }}">
                                                                            {{ $category->name }}
                                                                        </a>
                                                                    </span>
                                                                </h3>
                        ...
                        <div class="row hide-for-small" id="row-1796734493">
                            <div id="col-1660835638" class="col small-12 large-12">
                                <div class="col-inner">
                                    <h2 class="title_dacbiet">
                                        <span><i class="fa fa-lightbulb-o"></i></span>
                                        <a title="{{ $category->name }}" href="/shop?category={{ $category->slug }}">{{
                                            $category->name }}</a>
                                    </h2>
                                </div>
                            </div>
                                                    ...
                                                    <div class="box-image">
                                                        <div class="">
                                                            ...
                                                            <style>
                                                                ...
                                                                .product-image-wrapper:hover .back-image {
                                                                    opacity: 1;
                                                                    /* Hiện ảnh 2 khi hover */
                                                                }
                                                            </style>
                                                        </div>
                                                    </div>
