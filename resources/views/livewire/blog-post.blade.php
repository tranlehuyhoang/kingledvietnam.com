...
/* ]]> */
            ...
            <link rel="alternate" title="oNhúng (XML)" type="text/xml+oembed"
                href="/assets/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fkingledvietnam.com%2Fkingledvietnam-thong-bao-lich-nghi-tet-duong-2024%2F&#038;format=xml" />
            ...
            <script type="application/ld+json">
                {"@context":"https:\/\/schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"item":{"@id":"https:\/\/kingledvietnam.com\/","name":"Home"}},{"@type":"ListItem","position":2,"item":{"@id":"https:\/\/kingledvietnam.com\/kingledvietnam-thong-bao-lich-nghi-tet-duong-2024\/","name":"Kingledvietnam : Th\u00f4ng b\u00e1o l\u1ecbch ngh\u1ec9 t\u1ebft d\u01b0\u01a1ng 2024"}}]}
        ...
        <body data-rsssl=1
            class="post-template-default single single-post postid-6543 single-format-standard theme-flatsome woocommerce-no-js wp-schema-pro-2.7.10 lightbox nav-dropdown-has-arrow nav-dropdown-has-shadow nav-dropdown-has-border">
                                ...
                                <div class="flex-col hide-for-medium flex-left">
                                    <ul
                                        ...
                                        <li id="menu-item-3188"
                                            class="menu-item menu-item-type-taxonomy menu-item-object-category current-post-ancestor current-menu-parent current-post-parent menu-item-3188 active menu-item-design-default">
                            ...
                            <div class="large-10 col">
                                ...
                                <div id="comments" class="comments-area">
                                    ...
                                    <div id="respond" class="comment-respond">
                                        <h3 id="reply-title" class="comment-reply-title">Để lại một bình luận <small><a
                                        ...
                                        <form action="/assets/wp-comments-post.php" method="post"
                                            ...
                                            <p class="comment-form-url"><label for="url">Trang web</label> <input
                                                    id="url" name="url" type="url" value="" size="30" maxlength="200"
                                                    autocomplete="url" /></p>
                                            <p class="form-submit"><input name="submit" type="submit" id="submit"
                                                    class="submit" value="Gửi bình luận" /> <input type='hidden'
                                                    name='comment_post_ID' value='6543' id='comment_post_ID' />
                                                <input type='hidden' name='comment_parent' id='comment_parent'
                                                    value='0' />
                                            </p>
                                            <p style="display: none;"><input type="hidden" id="akismet_comment_nonce"
                                                    name="akismet_comment_nonce" value="d8964a8437" /></p>
                                            <p style="display: none !important;" class="akismet-fields-container"
                                                data-prefix="ak_"><label>&#916;<textarea name="ak_hp_textarea" cols="45"
                                                    ...
                                                    id="ak_js_1" name="ak_js" value="200" />
                                                <script>
                            ...
                            <form class="woocommerce-form woocommerce-form-login login" method="post">
                                ...
                                <p class="form-row">
                                    ...
                                    <input type="hidden" id="woocommerce-login-nonce" name="woocommerce-login-nonce"
                                        ...
                                        value="/kingledvietnam-thong-bao-lich-nghi-tet-duong-2024/" /> <button
